...
let s:l = 67 - ((46 * winheight(0) + 39) / 79)
...
normal! 0
tabnext
edit ~/Dropbox/scripts/queries/fusion_po_agents.pls
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
normal! 0
tabnext
edit ~/Desktop/sites_approvals.txt
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 72 - ((57 * winheight(0) + 39) / 79)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
72
...
set stal=1
badd +0 ~/.vim/vimrc
badd +23 ~/Dropbox/vim/pasteboard.txt
badd +0 ~/Dropbox/scripts/queries/fusion_po_agents.pls
badd +1 ~/Desktop/Approval_Rules_19Bex2.json
badd +2 ~/Dropbox/docs/Oracle\ documentation/define_po_agents_dff.md
badd +2 ~/Dropbox/docs/Oracle\ documentation/notification_invoice_without_PO_rec.txt
badd +8 ~/Desktop/Approval_Rules19BTest.json
badd +1 ~/vimwiki/index.wiki
badd +16 ~/vimwiki/Cash\ Management\ Implementation.wiki
badd +2 ~/Dropbox/docs/Oracle\ documentation/areas_of_interest.txt
badd +0 ~/Dropbox/docs/Oracle\ documentation/buIDs.txt
badd +0 ~/Desktop/sites_approvals.txt
badd +5 ~/Desktop/Approval_Rules_19BTest.json
badd +10 ~/Desktop/Approval_Rules_19B_Test.json
